...
class ChromaBackground {
	...
	public ChromaBackground(Context context) throws Exception {
		...
		final String vertexShader = RawResourceReader.readTextFileFromRawResource(context, R.raw.background_v);   		
		...
		final String fragmentShader = RawResourceReader.readTextFileFromRawResource(context, R.raw.background_f);
